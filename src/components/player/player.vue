      ...
      <div class="mini-player" v-show="!fullScreen" @click="open">
        ...
        <div class="control">
          <progress-circle :radius="radius" :percent="percent">
            <i :class="miniIcon" @click.prevent.stop="togglePlay" class="icon-mini"></i>
          </progress-circle>
        </div>
        <div class="control">
  ...
  export default {
    ...
    methods: {
      ...
      handlelyric({lineNum, txt}) {
        ...
        if (lineNum - 1 >= 0) {
          this.$refs.lyricLine[lineNum - 1].style.fontSize = ''
        }
        this.$refs.lyricLine[lineNum].style.fontSize = '16px'
        if (lineNum > 5) {
