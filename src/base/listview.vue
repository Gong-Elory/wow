<template>
  <scroll class="listview" :datas="data" ref="listview" :listenScroll="listenScroll" @scroll="scroll" :probeType="probeType">
    <div v-if="!data.length" class="loading-container">
      <loading></loading>
    </div>
    <ul v-else="!data.length">
  ...
  export default {
    ...
    methods: {
      ...
      onShortcutTouchMove(e) {
        ...
        let anchorIndex = parseInt(this.touch.aindex) + delta
        this._scrollTo(anchorIndex)
      },
      scroll(pos) {
        this.scrollY = pos.y
